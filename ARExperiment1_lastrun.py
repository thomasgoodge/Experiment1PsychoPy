...
expName = 'ARExperiment1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Files\\Python Scripts\\PsychoPy Experiments\\Experiment 1\\ARExperiment1_lastrun.py',
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *key_resp_4* updates
        if key_resp_4.status == NOT_STARTED and t >= 0.5-frameTolerance:
            # keep track of start time/frame for later
