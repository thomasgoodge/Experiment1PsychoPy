...
IntroText = visual.TextStim(win=win, name='IntroText',
    text='Welcome to the experiment!\n\nColoured circle cues will appaear on the screen at random intervals, paired with a beep. Your task is to press the space bar whenever the red circle appears, but not the yellow or orange circles.\n\nPress the space bar to begin the practice trials.\n',
    font='Arial',
...
pauseRoutineClock = core.Clock()
text_3 = visual.TextStim(win=win, name='text_3',
    text='Press the space bar when you are ready to begin the experiment',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
for thisTrial_2 in trials_2:
    ...
    # keep track of which components have finished
    PracticeTrialComponents = [target, key_resp_4, sound_1]
    ...
    trials_2.addData('key_resp_4.started', key_resp_4.tStart)
    trials_2.addData('key_resp_4.stopped', key_resp_4.tStop)
...
# update component parameters for each repeat
# keep track of which components have finished
pauseRoutineComponents = [text_3]
for thisComponent in pauseRoutineComponents:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
pauseRoutineClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    tThisFlip = win.getFutureFlipTime(clock=pauseRoutineClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
